...
class TranscribeAI:
    ...
    def __init__(self, master):
        ...
        self.label = Label(master, text="Selecciona un archivo en formato .wav \n y presiona el botón 'Enviar a Azure'")
        self.label.pack()

        # Boton para seleccionar un archivo de audio
        self.openDocumentButton = Button(master, text="Seleccionar archivo", command=self.select_file)
        self.openDocumentButton.pack()

        self.documentSelected = Label(master, text=f"Archivo seleccionado: {TranscribeAI.filePath}")
        self.documentSelected.pack()

        self.sendToAzureButton = Button(master, text="Enviar a Azure", state="disabled", command=self.send_to_azure)
    ...
    def create_document_with_text(self, text):
        ...
        self.documentSelected.configure(text=f"Archivo seleccionado: {TranscribeAI.filePath}")
    ...
    def select_file(self):
        ...
        self.documentSelected.configure(text=f"Archivo seleccionado: \n {TranscribeAI.filePath}")
